...
class DiscordWebHookPayload {
     ...
     */
    var embeds: Array<DiscordEmbed?>? = null

    /**
     * Creates a new [DiscordWebHookPayload] that is prepared to send a simple text message bundled with an embed.
     * 
     ...
     */
    constructor(username: String?, avatar_url: String?, tts: Boolean, content: String?, embeds: Array<DiscordEmbed?>?) {
    ...
    /**
     * Creates a new [DiscordWebHookPayload] that is prepared to be send as a simple text message
     * 
     * @param username   The username that will be used as the sender username
     * @param avatar_url The url to the avatar to use in the message
     * @param tts        Enable or disable the text-to-speech feature for this message
     * @param content    The content as a simple text message that should be send with the payload
     */
    constructor(username: String?, avatar_url: String?, tts: Boolean, content: String?) {
        this.username = username
        this.avatar_url = avatar_url
        this.isTts = tts
        this.content = content
    ...
    /**
     * Creates a new [DiscordWebHookPayload] that is prepared to be send bundled with [DiscordEmbed]'s
     * 
     * @param username   The username that will be used as the sender username
     * @param avatar_url The url to the avatar to use in the message
     * @param embeds     The embeds that should be send with the payload
     */
    constructor(username: String?, avatar_url: String?, embeds: Array<DiscordEmbed?>?) {
        this.username = username
        this.avatar_url = avatar_url
        this.embeds = embeds
    }
